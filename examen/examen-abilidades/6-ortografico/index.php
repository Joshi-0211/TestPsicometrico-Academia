...
<body>
  ...
  <div class="result_box">
      ...
      <p>no olvides que las puntuaciones que anotaste ayudaran a que tengas una mejor idea de cuales son tus mejores habilidades y poder escojer mucho mejor tu carrera. </p>
      <div class="buttons">
        <input type="button" value="volver al inicio" onclick="location.href='../../../eleccion-examen/eleccion_examen.php'">
      </div>
  </div>
